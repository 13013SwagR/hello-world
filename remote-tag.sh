...
curl -X PUT -H "Content-Type: ${CONTENT_TYPE}" -H "Authorization: Bearer Z2hwX0p0ZlZ4VUNzUFdLZ2l4ZFV6NUo3d0ZDRmRGc3pNejFBY3BMNwo=" -d "$MANIFEST" "$REGISTRY_NAME/v2/$REPOSITORY/manifests/$TAG_NEW"
